...
def statistics(traj_dir):
    ...
    for filename in tqdm(os.listdir(traj_dir)):
        ...
        for traj in trajs:
            ...
            length_data.append(traj.length() / 1000.0)
            duration_data.append(traj.duration() / 60.0)
            traj_avg_time_interval_data.append(traj.time_interval())
            traj_avg_dist_interval_data.append(traj.distance_interval())
